...
urlpatterns += [
    ...
    path('api/notebooks/<uuid:notebook_uuid>/cell-summaries/', views.api_get_notebook_cell_summaries, name='api_get_notebook_cell_summaries'),
    path('api/notebooks/<uuid:notebook_uuid>/cells/<int:cell_id>/results/', views.api_get_cell_results, name='api_get_cell_results'),
